...
import { getDB, type Subject, type EvaluationType, type ParticipationEntry, type ScheduleSlot, type WeekSystemSettings } from "@/lib/db"
import { isPastDate, getDayOfWeek, parseDate, getCurrentWeekType } from "@/lib/date-utils"
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card"
import { Button } from "@/components/ui/button"
import { Textarea } from "@/components/ui/textarea"
import { Plus, Trash2, Lock, AlertCircle, Calendar } from "lucide-react"
import {
  Dialog,
  DialogContent,
  DialogDescription,
              ...
              <div className="flex items-center justify-between gap-2">
                ...
                {!isReadOnly && (
                  ...
                  >
                    ...
                    <DialogContent>
                      <DialogHeader>
                        <DialogTitle>Neue Meldung für {subject.name}</DialogTitle>
