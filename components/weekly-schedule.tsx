...
import { getDB, type Subject, type EvaluationType, type ParticipationEntry } from "@/lib/db"
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <CardTitle>
              Woche {weekDates[0].getDate()}.{weekDates[0].getMonth() + 1}. - {weekDates[6].getDate()}.
                ...
                return (
                  <div
                    ...
                    className={`p-2 border-b border-r min-h-[60px] ${
                      isToday ? "bg-primary/5" : subjectIndex % 2 === 0 ? "bg-card" : "bg-muted/10"
                    }`}
                  >
                    {entries.length > 0 ? (
                      <div className="space-y-1">
                        ...
                        <div className="flex flex-wrap gap-1 justify-center">
                          ...
                          {entries.length > 10 && (
                            <span className="text-xs text-muted-foreground">+{entries.length - 10}</span>
                          )}
                        </div>
                      </div>
                    ) : (
